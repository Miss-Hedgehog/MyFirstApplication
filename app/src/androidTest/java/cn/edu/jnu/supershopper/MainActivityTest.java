...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.edittext_shop_item_title), withText("Name"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Nameert"));

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edittext_shop_item_title), withText("Nameert"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edittext_shop_item_price), withText("1.0"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.edittext_shop_item_price), withText("123"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textview_item_caption), withText("Nameert"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView2.check(matches(withText("Nameert")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textview_item_price), withText("123.0"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView3.check(matches(withText("123.0")));
    }
